...
def intent_config(intent_path):
    ...
    return {
        "dataset_reader": {
            ...
            "x_col_name": "text",
            "y_col_name": "intents",
            "data_path": f"{intent_path}/train.csv"
        },
        "dataset_iterator": {
        ...
        "chainer": {
            ...
            "pipe": [
                ...
                },
                {
                    ...
                    "id": "tfidf_vec",
                    "class_name": "sklearn_component",
                    "save_path": f"{intent_path}/tfidf.pkl",
                    "load_path": f"{intent_path}/tfidf.pkl",
                    "model_class": "sklearn.feature_extraction.text:TfidfVectorizer",
                    "infer_method": "transform"
                },
                {
                    ...
                    "save_path": f"{intent_path}/en_mipt_answers.dict",
                    "load_path": f"{intent_path}/en_mipt_answers.dict",
                    "in": "y",
                    "out": "y_ids"
                },
                {
                    ...
                    "class_name": "sklearn_component",
                    "main": True,
                    "save_path": f"{intent_path}/logreg.pkl",
                    "load_path": f"{intent_path}/logreg.pkl",
                    "model_class": "sklearn.linear_model:LogisticRegression",
        ...
        # "metadata": {
        #     "variables": {
        #         "ROOT_PATH": f"{intent_path}/",
        #         "DOWNLOADS_PATH": f"{intent_path}/downloads",
        #         "MODELS_PATH": f"{intent_path}/models"
        #     },
        #     "requirements": [
        #         f"{intent_path}/spacy.txt",
        #         f"{intent_path}/en_core_web_sm.txt"
        #     ],
        #     "download": [
        #         {
